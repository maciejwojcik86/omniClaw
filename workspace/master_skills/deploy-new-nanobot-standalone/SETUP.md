# Setup: Deploy New Nanobot Standalone Skill

This file covers first-time setup for the standalone loose deploy skill and the optional packaging path for your local Nanobot fork.
...
workspace/master_skills/deploy-new-nanobot-standalone/scripts/package_nanobot_source.sh --apply --source-dir /home/macos/omniClaw/third_party/nanobot --output-dir /home/macos/.omniClaw/workspace/runtime_packages
```
...
```bash
cd /home/macos/omniClaw
python3 workspace/master_skills/deploy-new-nanobot-standalone/scripts/create_workspace_tree.py --apply --workspace-root /home/macos/omniClaw/workspace/macos
```
