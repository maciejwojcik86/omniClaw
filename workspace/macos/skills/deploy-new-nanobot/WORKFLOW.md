...
- optional: `nanobot_source` and `package_output_dir` when you want a reusable archive of the vendored monorepo Nanobot fork
...
1. optional `skills/deploy-new-nanobot/scripts/package_nanobot_source.sh` (archive the vendored `/home/macos/omniClaw/third_party/nanobot` fork)
