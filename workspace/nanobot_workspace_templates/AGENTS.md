...
- Daily self budget inflow: ${{budget.daily_inflow_usd}}
- Rollover reserve: ${{budget.rollover_reserve_usd}}
- Remaining budget: {{budget.remaining_usd}}
- Budget review notice: {{budget.review_required_notice}}
