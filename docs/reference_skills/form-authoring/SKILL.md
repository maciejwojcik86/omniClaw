...
The Kernel uses JSON schemas to decide where to send the .md file from your /outbox/send/ folder. The decision from one state to another occurs when you change the action\_taken value in the form's YAML header.
