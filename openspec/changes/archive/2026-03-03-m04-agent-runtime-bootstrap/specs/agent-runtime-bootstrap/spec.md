## ADDED Requirements
> Legacy archive note: this historical artifact preserves pre-rename wording (including "transitions") from the original M04 runtime-state documentation.
...
- **THEN** the kernel defaults workspace to `<repo-root>/workspace/humans/<linux-username>` and scaffolds the standard workspace structure
