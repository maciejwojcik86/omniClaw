...
- Run Nullclaw command under the provisioned agent Linux user.
- Seed missing runtime files (`notes/TODO.md`, `persona_template.md`) before execution in `~/.nullclaw/workspace`.
...
4. If smoke fails, rollback by disabling runtime endpoint path and keeping M03 provisioning intact.
