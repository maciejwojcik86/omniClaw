# runtime-packaging-boundary Specification

## Purpose
Define the packaging and installation boundary between OmniClaw and the vendored Nanobot runtime inside the monorepo.
