...
from _nanobot_skill_common import company_workspace_root, template_root
...
def derive_instruction_template_root(*, node_name: str) -> Path:
    return company_workspace_root() / "nanobots_instructions" / node_name
